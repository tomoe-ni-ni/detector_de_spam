...
SAVE_DIR = os.path.expanduser('/home/johnrobin123/models/')
if not os.path.exists(SAVE_DIR):
    os.makedirs(SAVE_DIR)

# Cargar el CSV con los enlaces maliciosos
df = pd.read_csv('links_maliciosos_actualizado.csv')

# Usar la columna 'Link_Malicioso' como texto de entrada y 'Malicioso' como etiqueta
X = df['Link_Malicioso']
y = df['Malicioso']  # La columna ya contiene 0 y 1
